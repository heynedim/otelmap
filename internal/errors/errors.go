...
var ErrWhileGettingEdges = errors.New("error while getting edges")
var ErrWhileGettingServicesWithMetrics = errors.New("error while getting services with metrics")
